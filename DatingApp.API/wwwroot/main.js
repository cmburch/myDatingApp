...
var ListsResolver = /** @class */ (function () {
    function ListsResolver(userService, router, toastr) {
    ...
    ListsResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUsers(this.pageNumber, this.pageSize, null, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) {
            _this.toastr.error('Problem retrieving data');
...
var MemberDetailResolver = /** @class */ (function () {
    function MemberDetailResolver(userService, router) {
        this.userService = userService;
        this.router = router;
    }
...
var MemberEditResolver = /** @class */ (function () {
    function MemberEditResolver(userService, router, authService) {
        this.userService = userService;
        this.router = router;
        this.authService = authService;
    }
...
var MemberListResolver = /** @class */ (function () {
    function MemberListResolver(userService, router) {
        this.userService = userService;
        this.router = router;
        this.pageNumber = 1;
        this.pageSize = 5;
...
/* harmony import */ var _value_value_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./value/value.component */ "./src/app/value/value.component.ts");
...
/* harmony import */ var _route__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./route */ "./src/app/route.ts");
...
/* harmony import */ var time_ago_pipe__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! time-ago-pipe */ "./node_modules/time-ago-pipe/esm5/time-ago-pipe.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            declarations: [
                ...
                _value_value_component__WEBPACK_IMPORTED_MODULE_7__["ValueComponent"],
            ...
            imports: [
                ...
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_29__["BsDropdownModule"].forRoot(),
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_29__["BsDatepickerModule"].forRoot(),
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_29__["ButtonsModule"].forRoot(),
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_29__["PaginationModule"].forRoot(),
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_29__["TabsModule"].forRoot(),
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_17__["RouterModule"].forRoot(_route__WEBPACK_IMPORTED_MODULE_18__["appRoutes"]),
...
module.exports = ".hero-image {\n  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('dating.jpg');\n  height: 100vh;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  position: relative;\n}\n\n\n.hero-center {\n  text-align: center;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  -webkit-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%);\n  color: white;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div>\n  <div class=\"hero-image\">\n\n  <div class=\"hero-center\">\n  <div *ngIf=\"!registerMode\" style=\"text-align: center\">\n\n    <h1>Find your match</h1>\n    <p  *ngIf=\"!loggedIn(); else notShow\" class=\"lead\">Come on in to view your matches... All you need to do is sign up!</p>\n    <ng-template #notShow>\n        <p>\n          Continue your search for your special someone!!!\n        </p>\n    </ng-template>\n    <div *ngIf=\"!loggedIn()\" class=\"text-center\">\n      <button class=\"btn btn-primary btn-lg mr-2\" (click)=\"registerToggle()\">Register</button>\n      <button [disabled]=\"true\" class=\"btn btn-info btn-lg\">Learn more</button>\n      <!-- <button class=\"btn btn-info btn-lg\">Learn more</button> -->\n    </div>\n  </div>\n</div>\n  <div *ngIf=\"registerMode\" class=\"container pt-5\">\n    <div class=\"row justify-content-center\">\n      <div class=\"col-4\">\n      <!-- register -->\n        <app-register (cancelRegister)=\"cancelRegisterMode($event)\"></app-register>\n      </div>\n    </div>\n  </div>\n</div>\n\n\n</div>\n\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]])
    ], HomeComponent);
...
var ListsComponent = /** @class */ (function () {
    ...
    ListsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"], ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"]])
    ], ListsComponent);
...
module.exports = ".card:hover img {\n  -webkit-transform: scale(1.2, 1.2);\n          transform: scale(1.2, 1.2);\n  transition-duration: 500ms;\n  transition-timing-function: ease-out;\n  opacity: 0.7;\n}\n\n.card img {\n  -webkit-transform: scale(1.0, 1.0);\n          transform: scale(1.0, 1.0);\n  transition-duration: 500ms;\n  transition-timing-function: ease-out;\n}\n\n.card-img-wrapper {\n  overflow: hidden;\n  position: relative;\n}\n\n.member-icons {\n  position: absolute;\n  bottom: -30%;\n  left: 0;\n  right: 0;\n  margin-right: auto;\n  margin-left: auto;\n  opacity: 0;\n}\n\n.card-img-wrapper:hover .member-icons {\n  bottom: 0;\n  opacity: 1;\n}\n\n.animate {\n  transition: all 0.3s ease-in-out;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MemberCardComponent = /** @class */ (function () {
    function MemberCardComponent(authService, userService, toastr) {
        this.authService = authService;
        this.userService = userService;
        this.toastr = toastr;
    }
    ...
    MemberCardComponent.prototype.sendLike = function (id) {
        ...
        this.userService.sendLike(this.authService.decodedToken.nameid, id).subscribe(function (data) {
            _this.toastr.success('You have liked: ' + _this.user.knownAs);
        }, function (error) {
            _this.toastr.error(error);
        });
    };
...
module.exports = ".img-thumbnail {\n  margin: 25px;\n  width: 85%;\n  height: 220px;\n}\n\n/* .img-thumbnail {\n  margin: 25px;\n  width: 85%;\n  height: 85%;\n} */\n\n.card-body {\n  padding: 0 25px;\n}\n\n.card-footer {\n  padding: 10px 15px;\n  background-color: #fff;\n  border-top: none;\n}\n\n/* .card-img-top .img-thumbnail{\n  height:220px;\n} */\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MemberDetailComponent = /** @class */ (function () {
    function MemberDetailComponent(userService, toastr, authService, route) {
        this.userService = userService;
        this.toastr = toastr;
        this.authService = authService;
        this.route = route;
    ...
    MemberDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_1__["ToastrService"],
            _services_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]])
...
module.exports = ".img-thumbnail {\n  margin: 25px;\n  width: 85%;\n  /* height: 85%; */\n}\n\n.card-body {\n  padding: 0 25px;\n}\n\n.card-footer {\n  padding: 10px 15px;\n  background-color: #fff;\n  border-top: none;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MemberEditComponent = /** @class */ (function () {
    function MemberEditComponent(route, userService, authService) {
        this.route = route;
        this.userService = userService;
        this.authService = authService;
    }
    ...
    MemberEditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]])
    ], MemberEditComponent);
...
module.exports = ".flex-container {\n    display: flex;\n    margin-top: 8px;\n    justify-content: space-between;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MemberListComponent = /** @class */ (function () {
    function MemberListComponent(userService, route, toastr) {
        this.userService = userService;
        this.route = route;
        this.toastr = toastr;
...
var MemberMessagesComponent = /** @class */ (function () {
    function MemberMessagesComponent(userService, authService, toastr) {
        this.userService = userService;
        this.authService = authService;
        this.toastr = toastr;
        this.newMessage = {};
...
module.exports = "img.img-thumbnail {\n  height: 100px;\n  min-width: 100px !important;\n  margin-bottom: 2px;\n}\n\n.nv-file-over {\n  border: dotted 3px red;\n}\n\ninput[type=file] {\n  color: transparent;\n}\n\n.not-approved {\nopacity: 0.2;\n}\n\n.img-wrapper {\nposition: relative;\n}\n\n.img-text {\nposition: absolute;\nbottom: 30%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PhotoEditorComponent = /** @class */ (function () {
    function PhotoEditorComponent(authService, userService) {
        this.authService = authService;
        this.userService = userService;
    ...
    PhotoEditorComponent.prototype.initializeUploader = function () {
        ...
        this.uploader.onSuccessItem = function (item, response, status, headers) {
            if (response) {
                ...
                // this updates user photo to the main photo after the first intial upload
                if (photo.isMain) {
...
var MessagesComponent = /** @class */ (function () {
    function MessagesComponent(userService, authService, route, toastr) {
        this.userService = userService;
        this.authService = authService;
        this.route = route;
        this.toastr = toastr;
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        var _this = this;
        // this.toastr.success('Are you sure you want to delete this message?', () => {
        this.userService.deleteMessage(id, this.authService.decodedToken.nameid).subscribe(function () {
            ...
            _this.toastr.success('Message has been deleted');
        }, function (error) {
            _this.toastr.error('Failed to delete the message');
        });
        // });
    };
    ...
    MessagesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"],
            _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"], ngx_toastr__WEBPACK_IMPORTED_MODULE_1__["ToastrService"]])
    ], MessagesComponent);
...
module.exports = ".dropdown-toggle, .dropdown-item {\n  cursor: pointer;\n}\n\nimg {\n  max-height: 50px;\n  border: 2px solid white;\n  display: inline;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], NavComponent);
    return NavComponent;
}());
...
module.exports = "\n.text-white{\n    color: white;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(authService, router, toastr, fb) {
        this.authService = authService;
        this.router = router;
        this.toastr = toastr;
        this.fb = fb;
    ...
    RegisterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
...
// resolve: {user: MemberEditComponent}},
...
module.exports = __webpack_require__(/*! /Users/charlesburch/Desktop/projects/MyDatingApp/DatingApp-Spa/src/main.ts */"./src/main.ts");
